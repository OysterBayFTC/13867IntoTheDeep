...
public class AutonomousLiftTranslate extends LinearOpMode {
    ...
    private static final double TARGET_POSITIONX1 = 140;
    ...
    private static final double targeLifttHeightdown = 800; // height for the lift  
    ...
    private class LiftTask1 implements Runnable {
        @Override
        public void run() {
            robot.ArmOne.setPower(-0.35);  // Optimized power from version 2
            robot.ArmTwo.setPower(-0.35);
